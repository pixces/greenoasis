                        ...
                        <tr>
                            ...
                            <td>
                                <span class="download-visa-<?php echo $visa['Visa']['id'] ?>">
                                    ...
                                    <?php } else { ?>
                                        <a href="#visaAppFormModal" class="icon-download-visa " data-toggle="modal" data-application-id="<?php echo $visa['Visa_Booking']['id']; ?>"
                                           data-remote="<?= SITE_URL . "/admin/load_visa_form/" . $visa['Visa_Booking']['id'] . '?interface=admin'; ?>">
                                            <i style="cursor: not-allowed" class="icon-download-visa "></i>
                                        </a>
                                    <?php } ?>
                                </span>
                            </td>
                            <td>
                                <span class="download-visa-<?php echo $visa['Visa_Booking']['invoice_no'] ?>">
                                    <?php if (!is_null($visa['Visa_Booking']['invoice_file_name'])) { ?>
                                        <a href="<?php echo SITE_URL . '/admin/download_invoice_document/' . json_decode($visa['Visa_Booking']['invoice_file_name']); ?>"> <?php echo $visa['Visa_Booking']['invoice_no'] ?></a>
                                    <?php } else { ?>
                                        <a href="#invoiceAppFormModal" class="icon-download-visa " data-toggle="modal" data-application-id="<?php echo $visa['Visa_Booking']['id']; ?>"
                                           data-remote="<?= SITE_URL . "/admin/load_invoice_form/" . $visa['Visa_Booking']['id'] . '?interface=admin'; ?>">
                                            <i style="cursor: not-allowed" class="icon-download-visa "></i>
                                        </a>
                                    <?php } ?>
                                </span>
                            </td>
                            <td><?php echo $visa['Visa_Booking']['remark']; ?></td>
...
<!--starts: modal for visa application form -->
<div id="visaAppFormModal" class="modal hide fade " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:620px; left:49%;">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 style="color: #90c53f;" id="visaModalLabel">Visa Application Form</h3>
    </div>
    <div class="modal-body">
        <p>One fine body…</p>
    </div>
...
<!--ends: modal for visa application  form -->



<!--starts: modal for visa application form -->
<div id="invoiceAppFormModal" class="modal hide fade " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:620px; left:49%;">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 style="color: #90c53f;" id="visaModalLabel">Invoice Application Form</h3>
    </div>
    <div class="modal-body">
        <p>One fine body…</p>
    </div>
