...
<section class="manage-image">
    ...
    <div id="hotel_image-<?=$image['id']; ?>" class="pull-left">
        <img class="img-polaroid" src="<?=SITE_UPLOAD.PREFIX_THUMB.$image['image_name']; ?>" width="<?=IMG_WIDTH_THUMB; ?>" height="<?=IMG_HEIGHT_THUMB; ?>">
        <a class="delete-link btn btn-mini" href="#" id="<?=$image['id']; ?>" data-type="hotel_image" data-action="delete" date-value="<?=$image['id']; ?>" data-title="<?=$image['image_caption']; ?>" title="Delete image <?=$image['image_caption']; ?>"><i class="icon-trash"></i> Delete</a>
    </div>
    <?php } } ?>
</section>