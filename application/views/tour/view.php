...
<div class="content bg-white">
    <div class="container">
        <div class="heading"><h1>Dubai Desert Safari</h1></div>
            ...
            <div class="tour-main-panel">
                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="active item"><img alt="Dubai Desert Safari" src="<?=SITE_UPLOAD."tour01.jpg"; ?>"></div>
                        <div class="item"><img alt="Dubai Desert Safari" src="<?=SITE_UPLOAD."tour02.jpg"; ?>"></div>
                        <div class="item"><img alt="Dubai Desert Safari" src="<?=SITE_UPLOAD."tour03.jpg"; ?>"></div>
                        <div class="item"><img alt="Dubai Desert Safari" src="<?=SITE_UPLOAD."tour04.jpg"; ?>"></div>
                    </div>
                    <!-- Carousel nav -->
                ...
                <div class="clearfix package-policy tabbable">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab3" data-toggle="tab">Cancellation Policy</a></li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab2">
                            <p>These are all the terms and conditions</p>
                        </div>
