...
class Hotel extends Model {
    ...
    var $hasMany = array('Hotel_Tariff' => 'Hotel_Tariff', 'hotel_Reservation' => 'Hotel_Reservation');
    ...
    public function getHotelSummary($id) {
        $sQl = 'SELECT *  FROM `' . $this->_table . '` where `id` = ' . $id;
        $res = $this->custom($sQl);
        if ($res) {
            return isset($res[0]['Hotel']['hotel_name']) ? $res[0]['Hotel']['hotel_name'] : '';
        }
